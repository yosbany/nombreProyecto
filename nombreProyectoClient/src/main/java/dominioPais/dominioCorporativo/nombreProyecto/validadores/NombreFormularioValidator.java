...
public class NombreFormularioValidator implements Validator {
	...
	public void validate(Object arg0, Errors arg1) {
		...
		// ValidationUtils.rejectIfEmptyOrWhitespace(e, "campo",
		// "error.campo.necesario");
		// NombreFormularioForm nombreFormularioForm = (NombreFormularioForm)
		// obj;

		/**
		 * Para no sacar 2 errores a la vez del mismo campo se hace esta
		 * condicional
		 */
